...
{
    time[0] = ((read_ds1307(0x02)>> 4) & 0x03) + '0';
    time[1] = (read_ds1307(0x02) & 0x0F) + '0';
    time[2] = ':';
    time[3] = ((read_ds1307(0x01) >> 4) & 0x07) + '0';
    time[4] = (read_ds1307(0x01) & 0x0F) + '0';
    time[5] = ':';
    time[6] = ((read_ds1307(0x00)>> 4)& 0x07) + '0';
    time[7] = (read_ds1307(0x00)&0x0F) + '0';
    time[8] = '\0';
...
void display(unsigned char *event,unsigned char speed)
{
    ...
    clcd_print_ch((speed/10)+'0',(0xC0 + (14)));
    clcd_print_ch((speed%10)+'0',(0xC0 + (15)));
}
...
unsigned char check_pssd(unsigned char key)
{
    ...
    else
    {
        ...
        clcd_print("You are block",(0x80 + (0)));
        clcd_print("for 120sec... ",(0xC0 + (0)));
        while(sec)
        {
            clcd_print_ch(sec/100 + '0', (0xC0 + (4)));
            clcd_print_ch((sec/10)%10 + '0', (0xC0 + (5)));
            clcd_print_ch(sec%10 + '0', (0xC0 + (6)));
    ...
    if(i == 4)
    {
        ...
        if(--attempt)
        {
            ...
            {
                clcd_write(0x01, 0);
                clcd_print("Login Failed",(0x80 + (0)));
                clcd_print_ch(attempt+'0',(0xC0 + (0)));
...
unsigned char login_screen(unsigned char key)
{
    ...
    if(i == 0)
    {
        clcd_print_ch(' ',(0xC0 + (0)));
        clcd_print(arr[i],(0x80 + (3)));
        clcd_print(arr[i+1],(0xC0 + (3)));
        clcd_print_ch('*',(0x80 + (0)));
    }
    else
    {
        clcd_print_ch(' ',(0x80 + (0)));
        clcd_print(arr[i-1],(0x80 + (3)));
        clcd_print(arr[i],(0xC0 + (3)));
        clcd_print_ch('*',(0xC0 + (0)));
    }
    return 3;
}
...
unsigned char set_time(unsigned char key)
{
    ...
    else if(key == 11)
    {
        ...
        while(read_key(1) == 11)
        {
            ...
            {
                num = ((sec/10)<<4) | (sec%10);
                write_ds1307(0x00,num);
                num = ((min/10)<<4) | (min%10);
                write_ds1307(0x01,num);
                num = ((h/10)<<4) | (h%10);
                write_ds1307(0x02,num);
                return 1;
            }
        }
    }
    if(j == 0)
    {
        ...
        if(++t < 150)
        {
            clcd_print_ch(' ',(0xC0 + (6)));
            clcd_print_ch(' ',(0xC0 + (7)));
        }
        else if(t == 300)
            t = 0;
        else
    ...
    else if(j == 1)
    {
        ...
        if(++t < 150)
        {
            clcd_print_ch(' ',(0xC0 + (3)));
            clcd_print_ch(' ',(0xC0 + (4)));
        }
        else if(t == 300)
            t = 0;
        else
        {
            clcd_print_ch(min/10 + '0',(0xC0 + (3)));
            clcd_print_ch(min%10 + '0',(0xC0 + (4)));
        }
    }
    else if(j == 2)
    {
        ...
        {
            clcd_print_ch(' ',(0xC0 + (0)));
            clcd_print_ch(' ',(0xC0 + (1)));
        }
        else if(t == 300)
            t = 0;
        else
        {
            clcd_print_ch(h/10 + '0',(0xC0 + (0)));
            clcd_print_ch(h%10 + '0',(0xC0 + (1)));
        }
    }
    ...
    clcd_print_ch(':',(0xC0 + (2)));
    if(j != 1)
    {
        clcd_print_ch(min/10 + '0',(0xC0 + (3)));
        clcd_print_ch(min%10 + '0',(0xC0 + (4)));
    }
    clcd_print_ch(':',(0xC0 + (5)));
    if(j != 0)
    {
        clcd_print_ch(sec/10 + '0',(0xC0 + (6)));
        clcd_print_ch(sec%10 + '0',(0xC0 + (7)));
